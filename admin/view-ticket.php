                        ...
                        <?php
                            ...
                            foreach($rows as $row){
                                ...
                                if(isset($_POST['resolved'])){
                                  $updateStatus = "UPDATE complains set status = '1' WHERE id = '$id'";
                                ...
                                echo "
                                    ...
                                    <td>
                                    <form method='post'>
                                    <input type='submit' name='resolved' value='Resolved' role='button' class='btn btn-outline-dark'>
                                    </form> </br>
                                    <form method='get'>
                                    <a href='reply-issue.php?id={$id}' name='{$id}'  role='button' class='btn btn-outline-success'>Reply</a>
                                    </form>
                                    </td>
                                    </tr>
                                ";
